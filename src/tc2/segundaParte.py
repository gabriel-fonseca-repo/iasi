...
from tc2.base.OrganizaImagens_Parte2 import getDadosImagens
...
W = (
    []
)  # lista de matrizes de pesos. W[l] é a matriz de pesos da camada l. Tendo dimensionamento ql x ql+1
i = []
y = []
delta = []
